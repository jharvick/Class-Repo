...
import com.example.recipe_api.models.dto.UpdatedRecipeDTO;
...
public class RecipeController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<RecipeDTO> updateRecipe(@Valid @RequestBody UpdatedRecipeDTO dto, @PathVariable Long id){
